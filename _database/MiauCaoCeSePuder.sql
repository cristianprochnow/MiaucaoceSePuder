...
usuario_nome_completo VARCHAR(200) NOT NULL,
usuario_telefone VARCHAR(80) NOT NULL,
usuario_estado VARCHAR(200) NOT NULL,
usuario_cidade VARCHAR(200) NOT NULL,
...
anuncio_desc VARCHAR(500),
anuncio_nome_completo VARCHAR(100) NOT NULL,
anuncio_numero_telefone VARCHAR(80) NOT NULL,
anuncio_email_contato VARCHAR(200),
anuncio_estado_local_animal VARCHAR(200) NOT NULL,
anuncio_cidade_local_animal VARCHAR(200) NOT NULL,
