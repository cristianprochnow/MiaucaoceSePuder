...
CREATE TABLE animal (
    ...
    CONSTRAINT fk_animal_cod_anuncio
	FOREIGN KEY (animal_cod_anuncio) 
	REFERENCES anuncio(cod_anuncio) 
	ON UPDATE CASCADE
	ON DELETE CASCADE,


	animal_cod_usuario INT NOT NULL,
    CONSTRAINT fk_animal_cod_usuario
	FOREIGN KEY (animal_cod_usuario) 
	REFERENCES usuario(cod_usuario) 
	ON UPDATE CASCADE
	ON DELETE CASCADE
...
CREATE TABLE contato (
    ...
    CONSTRAINT fk_contato_cod_usuario
	FOREIGN KEY (contato_cod_usuario) 
	REFERENCES usuario(cod_usuario) 
	ON UPDATE CASCADE
	ON DELETE CASCADE
