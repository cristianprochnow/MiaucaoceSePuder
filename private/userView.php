<?php
    ...
    if (isset($_GET['cod'])) {
        ...
        $_SESSION['codUsuario'] = trim(strip_tags(htmlspecialchars($_GET['cod'])));
...
<body>
    ...
    <a class="back-link" href="rootPageUsers.php"><i class="material-icons">arrow_back</i></a>
        ...
        <div id="caracteristicasTopicosGeraisAnimal" class="itensPerfilAnimal">
            <div class="cabecalhoProfile">
                <figure class="fotoPerfilAnimal">
                    <figcaption class="nomeAnimal">
                        <h1><?php print $userData['usuario_nome_completo']; ?> &nbsp; <i class="material-icons">person</i> </h1>
                    </figcaption>
                </figure>
            </div>
            ...
            <div id="característicasGeraisAnimal">
                <div class="titulosItens">
                    <p>Informações do Usuário <i class="material-icons" title="Editar Perfil">info</i> </p>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td id="button-cel">
                                            <div class="botaoVerMais">
                                                <button>
                                                    <?php print "<a href='animalView.php?cod={$cod_animal}'>Visualizar</a>"; ?>
                                                </button>
                                            </div>
                                        </td>
                                    </tr>
