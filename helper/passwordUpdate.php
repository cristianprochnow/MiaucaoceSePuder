                ...
                <?php
                    ...
                    if (isset($_POST['updateSubmit'])) {
                        ...
                        try {
                            ...
                            $query = 'SELECT cod_usuario FROM usuario WHERE usuario_nickname = :nickname AND usuario_email = :email';
                            $selectData = $connection -> prepare($query);

                            $selectData -> bindValue(':nickname', $_SESSION['usuario_nickname']);
                        ...
                        if (empty($_POST['codigoUsuario'])) {
                           ...
                           try {
                                ...
                                $updateQuery = 'UPDATE usuario SET usuario_senha = :senha WHERE cod_usuario = :cod';
                                $updateData = $connection -> prepare($updateQuery);

                                $updateData -> bindValue(':senha', $_SESSION['usuario_senha']);
                                ...
                                if ($updateData -> execute()) {
                                    ...
                                    ?>
                                        ...
                                        <div class="error-box">
                                            <p>Não foi possível realizar a atualização de senha. Por favor, tente novamente mais tarde.</p>
                                        </div>
