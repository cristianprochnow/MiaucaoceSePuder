    ...
    <body>
        <div id="main-content">
            <div id="secondary-content">
                ...
                <p class="secondary-content-p">Anúncio realizado de forma bem sucedida, <span id="username"><?php print $_POST['adUsername'] ?></span>. O(A) <span id="username"><?php print $_POST['adAnimalType'] ?></span> foi cadastrado.</p>
            </div>
